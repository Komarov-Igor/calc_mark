...
[
{
    ...
    [            
        ...
        { "text": "2", "id": "100.2", "eq_id": [1], "qty": [1],  "checked": false, "comment": "Необходимость поставки определяется на этапе обследования"  },
        { "text": "3", "id": "100.3", "eq_id": [1], "qty": [2],  "checked": false, "comment": "Необходимость поставки определяется на этапе обследования"  },
        { "text": "4", "id": "100.4", "eq_id": [1], "qty": [3],  "checked": false, "comment": "Необходимость поставки определяется на этапе обследования"  },
        { "text": "5", "id": "100.4", "eq_id": [1], "qty": [4],  "checked": false, "comment": "Необходимость поставки определяется на этапе обследования"  },
        { "text": "6", "id": "100.4", "eq_id": [1], "qty": [5],  "checked": false, "comment": "Необходимость поставки определяется на этапе обследования"  },
        { "text": "7", "id": "100.4", "eq_id": [1], "qty": [6],  "checked": false, "comment": "Необходимость поставки определяется на этапе обследования"  },
        { "text": "8", "id": "100.4", "eq_id": [1], "qty": [7],  "checked": false, "comment": "Необходимость поставки определяется на этапе обследования"  },
        { "text": "9", "id": "100.4", "eq_id": [1], "qty": [8],  "checked": false, "comment": "Необходимость поставки определяется на этапе обследования"  }
    ],
    "nextId": -1 
...
},
{
    ...
    [            
        ...
        { "text": "Термотрансферный маркиратор", "id": "101.1", "eq_id": [4,38,8,36], "qty": [1,1,1,1],  "checked": false },
