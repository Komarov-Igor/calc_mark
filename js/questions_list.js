...
},
{
    ...
    [            
        ...
        { "text": "Термоструйное нанесение кода на крышку", "id": "8.4", "qty": 1, "price": "1050800", "checked": false, "line_text":"Линейная станция маркировки (390000р)<br>• Принтер термоструйный (514300р)<br>• Система валидации нанесенного кода (146500р)", "comment": "" }
    ],
    "nextId": -1 
...
},
{
    "id": -1,
    "title": "Параметры линии #",
    "question": "Упаковка в групповую упаковку (короба)",
    "type": "radio",
    "answers": 
    [            
...
},
{
    "id": -1,
    "title": "Параметры линии #",
    "question": "Упаковка в транспортную упаковку (паллеты)",
    "type": "radio",
    "answers": 
    [            
