...
},
{
    ...
    [            
        ...
        { "text": "Прямое нанесение кода на боковую этикетку и технологического кода на крышку", "id": "101.3", "eq_id": [4,11,10], "qty": [1,2,1],  "checked": false  },
        { "text": "Прямое нанесение кода на крышку или боковую поверхность упаковки", "id": "101.4", "eq_id": [4,9,8,36], "qty": [1,1,1,1],  "checked": false, "comment": "Прямое нанесение термоструйным принтером" }
    ],
    "nextId": -1 
},
{
